...
- (void)showToastWithType:(JJCToastType)type
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self.toastView = [TSPToastView toastWithMessage:message
                                                  type:type
                                               originY:originY
                                              tipImage:image];
...
- (UIView *)maskViewWithColor:(UIColor *)color coverNav:(BOOL)coverNav {
    ...
    CGFloat topHeight = kTSPIsIphoneX ? 88 : 64;
    CGFloat y = coverNav ? 0 : topHeight;
    maskView.frame = CGRectMake(0, y, kTSPScreenWidth, KTSPScreenHeight - y);
