...
CGFloat const kTSPTextViewPlaceholderVerticalMargin = 8.0; ///< placeholder垂直方向边距
CGFloat const kTSPTextViewPlaceholderHorizontalMargin = 6.0; ///< placeholder水平方向边距

@interface TSPTextView ()

@property (nonatomic, copy) TSPTextViewwHandler changeHandler; ///< 文本改变Block
@property (nonatomic, copy) TSPTextViewwHandler maxHandler; ///< 达到最大限制字符数Block
@property (nonatomic, strong) UILabel *placeholderLabel; ///< placeholderLabel

@end

@implementation TSPTextView
...
- (void)initialize
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeTop
                                                    multiplier:1.0
                                                      constant:kTSPTextViewPlaceholderVerticalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeLeft
                                                    multiplier:1.0
                                                      constant:kTSPTextViewPlaceholderHorizontalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeWidth
                                                    multiplier:1.0
                                                      constant:-kTSPTextViewPlaceholderHorizontalMargin*2]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeHeight
                                                    multiplier:1.0
                                                      constant:-kTSPTextViewPlaceholderVerticalMargin*2]];
}
...
- (void)addTextDidChangeHandler:(TSPTextViewwHandler)changeHandler
{
